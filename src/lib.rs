...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DataSync processing");
    
    let mut processor = DataSyncProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DataSyncProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DataSyncProcessor::new(false);
